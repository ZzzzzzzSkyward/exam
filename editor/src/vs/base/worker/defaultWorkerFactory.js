...
function getWorker(workerId, label) {
    ...
    if (globals.MonacoEnvironment) {
        ...
        if (typeof globals.MonacoEnvironment.getWorkerUrl === 'function') {
            ...
            console.log(workerId,label,globals);
            //return navigator.worker.register(ttPolicy?
            return new Worker(ttPolicy ? 
            ttPolicy.createScriptURL(workerUrl) : workerUrl, { name: label });
        }
    }
    // ESM-comment-begin
